    ...
    >
      <div className="flex justify-end">
        ...
        >
          <span className="hidden md:block">
            {inputImage ? t('cancel') : t('addPhoto')}
          </span>{' '}
          {inputImage ? (
      ...
      {inputImage && (
        ...
        >
          ...
          >
            <p className="text-center text-gray-500">{t('grabOrAddPhoto')}</p>
            <input
              id="fileInput"
              type="file"
              multiple
                        ...
                        {(provided, snapshot) => (
                          ...
                          >
                            ...
                            <div className="ml-5 flex-grow">
                              ...
                              >
                                {isOldPhoto
                                  ? `${t('created')} ${dateFormater.format(photo.createdAt)} ${t('by')} ${photo.createdBy.username}`
                                  : t('newPhoto')}
                              </div>
                              <div
